...
client.on('message', msg => {
  ...
  if (msg.content === '1') {
    ...
    msg.reply('** ✦ وحده غبيه آتصلت بالخطوط قالت كم تستغرق رحله الريآض بانكوك قال لها بحظه ... قالت شكرا \n\n\n للمزيد الرجاء كتآبه الآتي \``تاني 1\`` ✦ **);
  }

});


**✦  ‫وحدة غبيه اتصلت بالخطوط قالت كم تستغرق رحله الرياض بانكوك ‫قال لها لحظه ... قالت شكرا‬ ✦n\n\n\ للمزيد الضغط عل \``تاني 1``\ **
